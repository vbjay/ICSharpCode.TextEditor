...
//                    + control.ActiveTextAreaControl.TextArea.TextView.DrawingPosition.Y;
            ...
            var rulerHeight = control.TextEditorProperties.ShowHorizontalRuler ? control.ActiveTextAreaControl.TextArea.TextView.FontHeight : 0;
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            drawingSize = TipPainterTools.GetDrawingSizeHelpTipFromCombinedDescription(
                this,
                pe.Graphics,
                Font,
                methodCountMessage,
        ...
        private class InsightDataProviderStackElement
        {
            ...
            {
                currentData = Math.Max(dataProvider.DefaultIndex, val2: 0);
